...
const T = {
  en: {
    ...
    vasAbout1: "Technology has revolutionized the world, and at Alphamovil we believe in revolutionizing technology.",
    ...
    vasDigitalDesc: "Alphamovil offers 360º digital marketing solutions to clients. We cover all aspects of digital marketing on all digital devices and offer various solutions to optimize your digital advertising spends.",
